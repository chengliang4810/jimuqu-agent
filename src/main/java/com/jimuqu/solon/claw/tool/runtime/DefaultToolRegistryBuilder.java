 ...
 *
 * <p>使用 Builder 模式简化 DefaultToolRegistry 的创建，避免伸缩构造函数。
 *
 * @author jimuqu
 * @since 1.0.0
 */
public class DefaultToolRegistryBuilder {
    ...
    /** 设置会话搜索服务。 */
    public DefaultToolRegistryBuilder sessionSearchService(
    ...
    /** 设置附件缓存服务。 */
    public DefaultToolRegistryBuilder attachmentCacheService(
    ...
    /** 设置运行时配置服务。 */
    public DefaultToolRegistryBuilder runtimeSettingsService(
    ...
    /** 设置网关运行时刷新服务。 */
    public DefaultToolRegistryBuilder gatewayRuntimeRefreshService(
    ...
    /** 设置文件与网络安全策略服务。 */
    public DefaultToolRegistryBuilder securityPolicyService(
    ...
    /** 设置危险操作审批服务。 */
    public DefaultToolRegistryBuilder approvalService(
    ...
    /** 设置浏览器自动化运行时。 */
    public DefaultToolRegistryBuilder browserRuntimeService(
    ...
    /** 设置图片生成服务。 */
    public DefaultToolRegistryBuilder imageGenerationService(
    ...
    /** 设置 Web 搜索提供方。 */
    public DefaultToolRegistryBuilder webSearchProviders(
