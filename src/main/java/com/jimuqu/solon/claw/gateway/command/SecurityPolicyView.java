...
public final class SecurityPolicyView {
    ...
    public static String render(AppConfig appConfig, String input) {
        ...
        if ("terminal-paste".equals(mode)) {
            return renderTerminalPastePolicy(AttachmentPathResolver.policySummary());
        }
    ...
    private static String renderTerminalGuardrailPolicy(Map<String, Object> guardrail) {
        ...
        buffer.append('\n')
                ...
                .append(" detached=")
                .append(value(guardrail, "detachedSessionLaunchersBlocked"))
                .append(" inlineAmpersand=")
                .append(value(guardrail, "inlineAmpersandBlocked"))
                .append(" trailingAmpersand=")
                .append(value(guardrail, "trailingAmpersandBlocked"));
        buffer.append('\n')
                .append("- PowerShell：blocked=")
                .append(value(guardrail, "powershellBackgroundCommandsBlocked"))
                .append(" requiresWait=")
                .append(value(guardrail, "powershellStartProcessRequiresWait"))
                .append(" noNewWindowNotEnough=")
                .append(value(guardrail, "powershellStartProcessNoNewWindowNotEnough"))
                .append(" passThruNotEnough=")
                .append(value(guardrail, "powershellStartProcessPassThruNotEnough"));
        buffer.append('\n')
    ...
    private static String renderToolArgsPolicy(Map<String, Object> toolArgs) {
        ...
        buffer.append('\n')
                ...
                .append(value(toolArgs, "patchTargetExtraction"));
        buffer.append('\n')
                .append("- 网络文件：downloadOutput=")
                .append(value(toolArgs, "downloadOutputPathOptionChecked"))
                .append(" detachedOutput=")
                .append(value(toolArgs, "downloadOutputDetachedOptionChecked"))
                .append(" uploadSource=")
                .append(value(toolArgs, "networkUploadSourcePathChecked"))
                .append(" credentialOnlyBlocked=")
                .append(value(toolArgs, "networkUploadCredentialOnlyBlocked"));
        buffer.append('\n')
                .append("- 代理和系统网络：proxy=")
                .append(value(toolArgs, "proxyOptionUrlChecked"))
                .append(" preproxy=")
                .append(value(toolArgs, "preproxyOptionUrlChecked"))
                .append(" dns=")
                .append(value(toolArgs, "systemDnsCommandChecked"))
                .append(" setx=")
                .append(value(toolArgs, "setxProxyEnvironmentChecked"))
                .append(" registry=")
                .append(value(toolArgs, "windowsRegistryProxyCommandChecked"));
        buffer.append('\n')
                .append("- 样例：urlKeys=")
    ...
    private static String renderTerminalOutputPolicy(Map<String, Object> output) {
        ...
        buffer.append('\n')
                ...
                .append(" executeNotice=")
                .append(value(output, "executeShellExitMeaningNotice"))
                .append(" retryErrors=")
    ...
    private static void appendExtendedPolicyLines(StringBuilder buffer, AppConfig config) {
        ...
        buffer.append('\n')
                ...
                .append(" streamBounded=")
                .append(value(attachment, "streamReadBounded"));
        Map<String, Object> paste = AttachmentPathResolver.policySummary();
        buffer.append('\n')
