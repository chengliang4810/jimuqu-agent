...
public final class AgentRuntimePolicy {
    private static final List<String> KNOWN_TOOL_NAMES = Arrays.asList(
    ...
    public static List<String> resolveAllowedTools(AgentRuntimeScope agentScope, List<String> allToolNames) {
    ...
    public static boolean isSkillAllowed(AgentRuntimeScope agentScope, SkillDescriptor descriptor) {
        ...
        return allowed.contains(descriptor.canonicalName()) || allowed.contains(descriptor.getName());
    }
    ...
    private static void addToolOrGroup(LinkedHashSet<String> output, String value) {
        ...
        if ("command".equals(key) || "commands".equals(key) || "shell".equals(key) || "terminal".equals(key)) {
