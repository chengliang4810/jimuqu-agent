...
public interface ConversationOrchestrator {
     ...
     */
    default GatewayReply handleIncoming(GatewayMessage message, ConversationEventSink eventSink) throws Exception {
     ...
     */
    default GatewayReply runScheduled(GatewayMessage syntheticMessage, ConversationEventSink eventSink) throws Exception {
     ...
     */
    default GatewayReply resumePending(String sourceKey, ConversationEventSink eventSink) throws Exception {
