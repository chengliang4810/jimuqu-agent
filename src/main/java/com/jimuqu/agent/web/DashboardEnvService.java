...
public class DashboardEnvService {
    ...
    public DashboardEnvService(AppConfig appConfig,
        ...
        this.definitions = Arrays.asList(
                ...
                new EnvVarDefinition("JIMUQU_REACT_MAX_STEPS", "主代理最大推理步数", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_REACT_RETRY_MAX", "主代理决策重试次数", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_REACT_RETRY_DELAY_MS", "主代理决策重试延迟（毫秒）", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_REACT_DELEGATE_MAX_STEPS", "子代理最大推理步数", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_REACT_DELEGATE_RETRY_MAX", "子代理决策重试次数", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_REACT_DELEGATE_RETRY_DELAY_MS", "子代理决策重试延迟（毫秒）", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_REACT_SUMMARIZATION_ENABLED", "启用 ReAct 工作记忆摘要守卫", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_REACT_SUMMARIZATION_MAX_MESSAGES", "ReAct 摘要触发消息阈值", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_REACT_SUMMARIZATION_MAX_TOKENS", "ReAct 摘要触发 token 阈值", "provider", false, true, null, Arrays.asList("llm")),
                new EnvVarDefinition("JIMUQU_COMPRESSION_SUMMARY_MODEL", "压缩/工作记忆摘要模型", "provider", false, true, null, Arrays.asList("llm")),
