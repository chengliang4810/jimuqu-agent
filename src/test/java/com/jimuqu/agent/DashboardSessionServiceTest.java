...
public class DashboardSessionServiceTest {
    ...
    void shouldBuildSessionTreeFromParentLinksAcrossSourceKeys() throws Exception {
        ...
        SessionRecord child = env.sessionRepository.cloneSession("MEMORY:lineage:child", root.getSessionId(), "child");
        child.setTitle("child");
        env.sessionRepository.save(child);

        SessionRecord grandchild = env.sessionRepository.cloneSession("MEMORY:lineage:grandchild", child.getSessionId(), "grandchild");
