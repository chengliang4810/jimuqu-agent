...
public class DomesticChannelEnhancementTest {
    ...
    void shouldParseQqbotInboundTextAndPlatformAsrText() {
        ...
        GatewayMessage text = adapter.parse("{\"t\":\"C2C_MESSAGE_CREATE\",\"d\":{\"id\":\"m1\",\"openid\":\"user-a\",\"content\":\"hello\"}}");
        GatewayMessage voice = adapter.parse("{\"t\":\"GROUP_AT_MESSAGE_CREATE\",\"d\":{\"id\":\"m2\",\"group_openid\":\"group-a\",\"author\":{\"user_openid\":\"user-a\"},\"asr_refer_text\":\"语音文本\"}}");
    ...
    void shouldParseYuanbaoInboundTextAndPlatformAsrText() {
        ...
        GatewayMessage message = adapter.parse("{\"body\":{\"chat_id\":\"room-a\",\"user_id\":\"user-a\",\"chat_type\":\"group\",\"voice\":{\"text\":\"平台转写\"},\"message_id\":\"m1\"}}");
    ...
    void shouldParseFeishuDocumentCommentEvent() {
        ...
        req.setPlain("{\"event\":{\"comment_id\":\"c1\",\"reply_id\":\"r1\",\"notice_meta\":{\"notice_type\":\"add_reply\",\"file_token\":\"ft\",\"file_type\":\"docx\",\"from_user_id\":{\"open_id\":\"ou_1\"}},\"reply_content\":{\"elements\":[{\"type\":\"text_run\",\"text_run\":{\"text\":\"请总结这一段\"}}]}}}");
