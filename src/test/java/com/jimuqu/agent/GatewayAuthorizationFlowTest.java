...
public class GatewayAuthorizationFlowTest {
    ...
    void shouldRequirePairingForSecondUserAfterAdminBootstrap() throws Exception {
        ...
        GatewayReply groupUnauthorized = env.gatewayService.handle(env.message("group-1", "user-2", "group", "Dev Group", "Bob", "hello group"));
        ...
        GatewayReply approve = env.send("admin-chat", "admin-user", "/pairing approve memory " + code);
