...
class SolonAiLlmGatewayToolEventTest {
    /** 远程工具超时会在工具链异常处理后形成 ToolResult.error，必须传递为失败事件。 */
    @Test
    void toolResultErrorKeepsRemoteTimeoutAsStructuredFailure() {
        String timeout = "Remote tool call timed out after 3.0s";
