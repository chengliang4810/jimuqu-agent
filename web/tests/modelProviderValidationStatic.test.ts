...
assert.ok(
  card.includes("model: props.provider.defaultModel || props.provider.models?.[0] || ''"),
  'validation should prefer the configured default model and fall back to the first provider model',
)
