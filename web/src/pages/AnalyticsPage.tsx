            ...
            return (
              ...
              >
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:block z-10 pointer-events-none">
                  <div className="rounded-2xl border border-white/75 bg-white/92 px-3 py-2 text-[10px] text-foreground shadow-[0_18px_32px_-24px_rgba(15,23,42,0.24)] whitespace-nowrap">
                ...
                {/* Input bar */}
                <div
                  className="w-full bg-sky-300/90"
                ...
                return (
                  <tr key={d.day} className="border-b border-border/50 hover:bg-secondary/20 transition-colors">
                    ...
                    <td className="text-right py-2 px-4">
                      <span className="text-sky-600">{formatTokens(d.input_tokens)}</span>
                    </td>
                    <td className="text-right py-2 pl-4">
                      <span className="text-primary">{formatTokens(d.output_tokens)}</span>
                    </td>
                  </tr>
                );
              })}
            ...
            <tbody>
              {sorted.map((m) => (
                <tr key={m.model} className="border-b border-border/50 hover:bg-secondary/20 transition-colors">
                  ...
                  <td className="text-right py-2 pl-4">
                    <span className="text-sky-600">{formatTokens(m.input_tokens)}</span>
                    {" / "}
                    <span className="text-primary">{formatTokens(m.output_tokens)}</span>
                  </td>
                </tr>
              ))}
            </tbody>
