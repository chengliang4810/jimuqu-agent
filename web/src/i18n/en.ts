...
export const en: Translations = {
  ...
  status: {
    ...
    doctorTitle: "Channel Doctor",
    setupReady: "Ready",
    missingConfig: "Missing config",
    connectionMode: "Mode",
    missingEnv: "Missing config",
    features: "Features",
    nextStep: "Next step",
    weixinQrStart: "Start Weixin QR",
  ...
  skills: {
    ...
    all: "All",
    noSkills: "No skills found. Skills are loaded from runtime/skills/",
  ...
  config: {
    configPath: "runtime/config.override.yml",
  ...
  env: {
    ...
    changesNote: "Changes are written to runtime/.env immediately. Existing sessions keep their current in-memory settings until the next run.",
